    ...
    <PanelLayout role="teacher" title="Teacher Dashboard">
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          { label: 'Leave Management', href: '/teacher/leave-management', icon: ClipboardList, color: 'text-purple-600 bg-purple-100' },
          { label: 'Form Download', href: '/teacher/form-download', icon: Download, color: 'text-orange-600 bg-orange-100' },
        ].map((item) => (
