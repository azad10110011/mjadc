...
export default function CollectedSummaryPage() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const res = await api.get<{ status: number; data: any }>(`/admin-panel/fees/collected-summary?${params}`)
      setData(res.data)
  ...
  return (
    <PanelLayout role="administration" title="Collected Amount Summary">
      <Card className="mb-6">
