...
export default function AdministrationDashboardPage() {
  ...
  const quickLinks = [
    { label: 'Notices', href: '/administration-panel/notices', icon: FileText, color: 'text-blue-600 bg-blue-100' },
    { label: 'Results', href: '/administration-panel/results', icon: GraduationCap, color: 'text-indigo-600 bg-indigo-100' },
    { label: 'Syllabus', href: '/administration-panel/syllabus', icon: BookOpen, color: 'text-green-600 bg-green-100' },
    { label: 'Routine', href: '/administration-panel/routine', icon: Calendar, color: 'text-purple-600 bg-purple-100' },
    { label: 'Fee Collection', href: '/administration-panel/fee-collection', icon: DollarSign, color: 'text-orange-600 bg-orange-100' },
    { label: 'Students', href: '/administration-panel/students', icon: Users, color: 'text-cyan-600 bg-cyan-100' },
    { label: 'Forms', href: '/administration-panel/forms', icon: Download, color: 'text-pink-600 bg-pink-100' },
  ]
