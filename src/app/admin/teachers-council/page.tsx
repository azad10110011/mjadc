...
export default function AdminTeachersCouncilPage() {
  ...
  const handleMoveUp = (id: number) => {
    api.post(`/admin/teachers-council/${id}/move-up`, {}).then(() => fetchMembers()).catch(() => {})
  }

  const handleMoveDown = (id: number) => {
    api.post(`/admin/teachers-council/${id}/move-down`, {}).then(() => fetchMembers()).catch(() => {})
  }
    ...
    <PanelLayout role="admin" title="Teachers Council">
      ...
      <Card>
        <CardContent className="pt-6">
          <h3 className="mb-4 font-semibold text-gray-900">Teachers Council Members</h3>
